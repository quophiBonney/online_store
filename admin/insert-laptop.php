...
<h5 class="m-0 font-weight-bold text-center text-uppercase">Laptop List</h5>
<p class="text-center">this is the full list of all the laptops that has been successfully added.</p>
<?php
...
<div class="input-group justify-content-center text-center">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-primary" data-toggle="modal"
        data-target="#addLaptop"><i class="fas fa-download fa-sm text-white-50 mr-2"></i>Add New
        Laptop</a>
...
<table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    if(mysqli_num_rows($query) > 0) {
        ...
        <tr>
            ...
            <td><?php echo substr($row['laptopDescription'], 0, 50);?>.....</td>
            ...
            function removeData(id) {
                if (confirm("Are you sure you want to remove item?")) {
                    window.location.href = 'delete-laptop.php?del_id=' + id + '';
                }
            }
            </script>
...
<!-- Add New Laptop -->
<div class="modal fade" id="addLaptop" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
aria-hidden="true">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h5 class="text-center p-3">Add New Laptop</h5>
            <form action="insert-laptop.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="text" name="laptopName" placeholder="Laptop Name" required=""
                        class="form-control" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="text" name="laptopDescription" placeholder="Laptop Description"
                ...
                <div class="form-group">
                    <button type="submit" name="addLaptop" class="form-control btn btn-primary">Add New
                        Laptop</button>
                </div>
            </form>
        </div>
