...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbarBackground">
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-md-6 card" data-aos="slide-up" data-aos-delay="200" data-aos-duration="200">
          <?php
            $id = $_GET['id']; 
          ...
          <div class="col-md-6 mt-5" data-aos="slide-up" data-aos-delay="100" data-aos-duration="1000">
            ...
            if(mysqli_num_rows($query) > 0){
              while($row = mysqli_fetch_assoc($query)){
                ?>
                   <form action="laptop_details.php?action=add&id=<?php echo $row['id']?>" method="POST" enctype="multi-part/form-data">
                <h5><?php echo $row['laptopName']?></h5>
                <p><?php echo $row['laptopDescription'];?></p>
