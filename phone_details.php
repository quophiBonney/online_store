    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbarBackground">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="allitems.html">All Items</a></li>
            ...
            <form action="phone_details.php" method="POST" class="d-flex" role="search">
      ...
      <div id="carouselExampleCaptions">
        <div class="">
          <div class="">
            <img src="assets/images/about-heading.jpg" class="d-block w-100" alt="...">
      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-md-6 card" data-aos="slide-up" data-aos-delay="100" data-aos-duration="1000">
          <?php
            $id = $_GET['id']; 
          ...
          <div class="col-md-6 mt-5" data-aos="slide-up" data-aos-delay="100" data-aos-duration="1000">
            <?php
            $id = $_GET['id']; 
            $sql = "SELECT * FROM phones WHERE id = '$id'";
            $query = mysqli_query($conn, $sql);
            if(mysqli_num_rows($query) > 0){
              while($row = mysqli_fetch_assoc($query)){
                ?>
                   <form action="phone_details.php?action=add&id=<?php echo $row['id']?>" method="POST" enctype="multi-part/form-data">
                <h5><?php echo $row['phoneName']?></h5>
                <p><?php echo $row['phoneDescription'];?></p>
...
<div class="container mt-5">
  <div class="row justify-content-center">
    ...
    <div class="col-6 col-xl-3 text-center" data-aos="slide-up" data-aos-delay="100" data-aos-duration="1000">
...
<!---- *** Featured Products & Items Ends Here *** ---->
        ...
        <div class="container">
          ...
          <div class="col-md-3 mt-5">
            <ul class="menu">
              ...
              <li><a href="allitems.html">Trending</a></li>
            </ul>
          </div>
          <div class="col-md-3 mt-5">
            <ul class="menu">
