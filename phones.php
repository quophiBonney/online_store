...
<head>
    ...
    <title>Phones - Clef's Ecommerce</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbarBackground">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form action="phones.php" method="POST" class="d-flex" role="search">
      ...
      <div id="carouselExampleCaptions">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h3>Get Amazing Discounts On Our Phones</h3>
                <p>Having the best and quality of mobile phones at a cool price is what do.</p>
              </div>
          </div>
